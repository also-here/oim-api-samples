...
public class RightNowFedAuthSyncPortClient
{
  @WebServiceRef
  private static RightNowSyncService rightNowSyncService;
    ...
    public static void main(String[] args) {
        try {
            ...
            RightNowFedAuthSyncPort rightNowFedAuthSyncPort = rightNowSyncService.getRightNowFedAuthSyncPort();

            Map<String, Object> requestContext = ((BindingProvider) rightNowFedAuthSyncPort).getRequestContext();
