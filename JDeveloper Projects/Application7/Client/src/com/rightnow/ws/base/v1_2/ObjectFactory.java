...
public class ObjectFactory {
    ...
    private final static QName _NamedIDWithParent_QNAME =
        new QName("urn:base.ws.rightnow.com/v1_2", "NamedIDWithParent");
    private final static QName _NamedIDHierarchyList_QNAME =
        new QName("urn:base.ws.rightnow.com/v1_2", "NamedIDHierarchyList");
    ...
    private final static QName _ChainDestinationID_QNAME =
        new QName("urn:base.ws.rightnow.com/v1_2", "ChainDestinationID");
    ...
    public JAXBElement<NamedIDHierarchyList> createNamedIDHierarchyList(NamedIDHierarchyList value) {
        return new JAXBElement<NamedIDHierarchyList>(_NamedIDHierarchyList_QNAME, NamedIDHierarchyList.class, null,
                                                     value);
    }
