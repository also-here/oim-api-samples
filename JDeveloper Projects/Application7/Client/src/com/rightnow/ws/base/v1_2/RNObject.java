...
import com.rightnow.ws.objects.v1_2.Asset;
import com.rightnow.ws.objects.v1_2.AssetStatus;
import com.rightnow.ws.objects.v1_2.ChannelType;
import com.rightnow.ws.objects.v1_2.Configuration;
import com.rightnow.ws.objects.v1_2.Contact;
import com.rightnow.ws.objects.v1_2.Country;
import com.rightnow.ws.objects.v1_2.Holiday;
import com.rightnow.ws.objects.v1_2.Incident;
import com.rightnow.ws.objects.v1_2.Mailbox;
import com.rightnow.ws.objects.v1_2.MessageBase;
...
@XmlType(name = "RNObject", propOrder = { "id", "lookupName", "createdTime", "updatedTime" })
@XmlSeeAlso({
            GenericObject.class, Incident.class, Variable.class, Country.class, AnalyticsReport.class, Task.class,
            ServiceDisposition.class, Holiday.class, SalesTerritory.class, Answer.class, ChannelType.class,
            Organization.class, SiteInterface.class, Asset.class, PurchasedProduct.class, MessageBase.class,
            SalesProduct.class, Mailbox.class, Account.class, ServiceProduct.class, Opportunity.class,
            StandardContent.class, AssetStatus.class, ServiceCategory.class, Contact.class, Configuration.class
    })
