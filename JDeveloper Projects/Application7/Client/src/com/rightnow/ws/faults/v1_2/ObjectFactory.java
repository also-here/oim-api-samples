...
public class ObjectFactory {
    ...
    private final static QName _RequestErrorFault_QNAME =
        new QName("urn:faults.ws.rightnow.com/v1_2", "RequestErrorFault");
    private final static QName _ServerErrorFault_QNAME =
        new QName("urn:faults.ws.rightnow.com/v1_2", "ServerErrorFault");
    private final static QName _UnexpectedErrorFault_QNAME =
        new QName("urn:faults.ws.rightnow.com/v1_2", "UnexpectedErrorFault");
    ...
    public JAXBElement<RequestErrorFaultType> createRequestErrorFault(RequestErrorFaultType value) {
        return new JAXBElement<RequestErrorFaultType>(_RequestErrorFault_QNAME, RequestErrorFaultType.class, null,
                                                      value);
    }
    ...
    public JAXBElement<UnexpectedErrorFaultType> createUnexpectedErrorFault(UnexpectedErrorFaultType value) {
        return new JAXBElement<UnexpectedErrorFaultType>(_UnexpectedErrorFault_QNAME, UnexpectedErrorFaultType.class,
                                                         null, value);
    }
