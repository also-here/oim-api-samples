...
@XmlType(name = "RNFault", propOrder = { "exceptionCode", "exceptionMessage" })
@XmlSeeAlso({ ServerErrorFaultType.class, RequestErrorFaultType.class, UnexpectedErrorFaultType.class })
