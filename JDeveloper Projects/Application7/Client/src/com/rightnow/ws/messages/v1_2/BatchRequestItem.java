...
@XmlType(name = "BatchRequestItem", propOrder = {
         "createMsg", "getMsg", "updateMsg", "destroyMsg", "queryCSVMsg", "queryObjectsMsg", "executeMarketingFlowMsg",
         "getFileDataMsg", "resetContactPasswordMsg", "sendMailingToContactMsg", "transferSubObjectsMsg",
         "getMetaDataMsg", "getMetaDataForClassMsg", "getMetaDataLastChangeTimeMsg", "getValuesForNamedIDMsg",
         "getValuesForNamedIDHierarchyMsg", "runAnalyticsReportMsg", "commitAfter", "preserveChainID"
    })
