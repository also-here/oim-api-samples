...
@XmlType(name = "BatchResponseItem", propOrder = {
         "createResponseMsg", "getResponseMsg", "updateResponseMsg", "destroyResponseMsg", "queryCSVResponseMsg",
         "queryObjectsResponseMsg", "executeMarketingFlowResponseMsg", "getFileDataResponseMsg",
         "resetContactPasswordResponseMsg", "sendMailingToContactResponseMsg", "getMetaDataResponseMsg",
         "transferSubObjectsResponseMsg", "getMetaDataForClassResponseMsg", "getMetaDataLastChangeTimeResponseMsg",
         "getValuesForNamedIDResponseMsg", "getValuesForNamedIDHierarchyResponseMsg", "runAnalyticsReportResponseMsg",
         "requestErrorFault", "serverErrorFault", "unexpectedErrorFault"
    })
