...
@XmlType(name = "MetaDataAttribute", propOrder = {
         "dataType", "dataTypeName", "metaDataLink", "isDeprecated", "description", "maxLength", "maxValue", "minValue",
         "name", "nullable", "pattern", "usageOnCreate", "usageOnDestroy", "usageOnGet", "usageOnUpdate", "usedAsName"
    })
