...
public class ObjectFactory {
    ...
    private final static QName _MetaDataRelationship_QNAME =
        new QName("urn:metadata.ws.rightnow.com/v1_2", "MetaDataRelationship");
    private final static QName _MetaDataClass_QNAME = new QName("urn:metadata.ws.rightnow.com/v1_2", "MetaDataClass");
    private final static QName _MetaDataAttribute_QNAME =
        new QName("urn:metadata.ws.rightnow.com/v1_2", "MetaDataAttribute");
    private final static QName _MetaDataAttributeList_QNAME =
        new QName("urn:metadata.ws.rightnow.com/v1_2", "MetaDataAttributeList");
    ...
    public JAXBElement<MetaDataRelationship> createMetaDataRelationship(MetaDataRelationship value) {
        return new JAXBElement<MetaDataRelationship>(_MetaDataRelationship_QNAME, MetaDataRelationship.class, null,
                                                     value);
    }
    ...
    public JAXBElement<MetaDataAttributeList> createMetaDataAttributeList(MetaDataAttributeList value) {
        return new JAXBElement<MetaDataAttributeList>(_MetaDataAttributeList_QNAME, MetaDataAttributeList.class, null,
                                                      value);
    }
