...
@XmlType(name = "AccountOptions", propOrder = {
         "accountLocked", "canModifyEmailSignature", "forcePasswordChange", "passwordNeverExpires",
         "permanentlyDisabled", "staffAssignmentDisabled", "viewsReportsDisabled", "virtualAccount"
    })
public class AccountOptions {
    ...
    /**
     * Gets the value of the canModifyEmailSignature property.
     *
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Sets the value of the canModifyEmailSignature property.
     *
     * @param value
     *     allowed object is
     *     {@link Boolean }
