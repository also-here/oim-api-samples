...
import com.rightnow.ws.nullfields.v1_2.AssignedSLAInstanceNullFields;


/**
 * <p>Java class for AssignedSLAInstance complex type.
 *
 ...
 *         &lt;element name="ValidNullFields" type="{urn:nullfields.ws.rightnow.com/v1_2}AssignedSLAInstanceNullFields" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AssignedSLAInstance", propOrder = {
         "activeDate", "expireDate", "id", "nameOfSLA", "remainingFromChat", "remainingFromCSR", "remainingFromEmail",
         "remainingFromWeb", "remainingTotal", "slaSet", "stateOfSLA", "validNullFields"
    })
public class AssignedSLAInstance {
    ...
    @XmlElement(name = "ID")
    protected ID id;
    @XmlElement(name = "NameOfSLA", nillable = true)
    protected NamedID nameOfSLA;
    @XmlElement(name = "RemainingFromChat", nillable = true)
    protected Integer remainingFromChat;
    @XmlElement(name = "RemainingFromCSR", nillable = true)
    protected Integer remainingFromCSR;
    @XmlElement(name = "RemainingFromEmail", nillable = true)
    protected Integer remainingFromEmail;
    @XmlElement(name = "RemainingFromWeb", nillable = true)
    protected Integer remainingFromWeb;
    @XmlElement(name = "RemainingTotal", nillable = true)
    ...
    protected AssignedSLAInstanceNullFields validNullFields;
     ...
     * @return
     *     possible object is
     *     {@link AssignedSLAInstanceNullFields }
     *
     */
    public AssignedSLAInstanceNullFields getValidNullFields() {
     ...
     *
     */
    public void setValidNullFields(AssignedSLAInstanceNullFields value) {
