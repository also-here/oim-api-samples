...
import com.rightnow.ws.nullfields.v1_2.CountryNullFields;
 ...
 *         &lt;element name="ValidNullFields" type="{urn:nullfields.ws.rightnow.com/v1_2}CountryNullFields" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Country", propOrder = {
         "abbreviation", "displayOrder", "isoCode", "name", "names", "phoneCode", "phoneMask", "postalMask",
         "provinces", "validNullFields"
    })
public class Country extends RNObject {
    ...
    @XmlElement(name = "Provinces", nillable = true)
    protected ProvinceList provinces;
    @XmlElement(name = "ValidNullFields", nillable = true)
    protected CountryNullFields validNullFields;
     ...
     *
     */
    public void setProvinces(ProvinceList value) {
     ...
     * @return
     *     possible object is
     *     {@link CountryNullFields }
     *
     */
    public CountryNullFields getValidNullFields() {
     ...
     *
     */
    public void setValidNullFields(CountryNullFields value) {
