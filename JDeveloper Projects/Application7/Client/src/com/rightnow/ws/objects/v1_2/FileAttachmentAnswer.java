...
@XmlType(name = "FileAttachmentAnswer", propOrder = { "disabled", "indexed", "_private" })
@XmlSeeAlso({ SharedFileAttachmentAnswer.class })
public class FileAttachmentAnswer extends FileAttachmentCommon {
