...
@XmlType(name = "FileAttachmentShared", propOrder = { "disabled", "names", "_private" })
@XmlSeeAlso({ SharedFileAttachmentShared.class })
public class FileAttachmentShared extends FileAttachment {
